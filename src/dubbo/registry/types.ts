...
export interface IDataConfigType {
  type: string;
  properties?: Record<string, string>;
}

export interface IRegistryDataConfig {
  methods: {
    name: string;
    parameterTypes: IDataConfigType['type'][];
    returnType: IDataConfigType['type'];
  }[];
  types: IDataConfigType[];
}
